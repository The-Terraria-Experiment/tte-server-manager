<template>
	<div :class="['bg-gray-3 rounded-xl overflow-hidden h-max w-full p-4 mb-4 sm:mb-8']">
		<h1 class="font-main font-bold text-teal-4 text-2xl">MANAGE INSTANCE</h1>
		<p class="font-main font-bold text-gray-7 mt-2">View machine status and manage files</p>
	</div>
