...
const FUNCTIONS = ["instance-manager", "server-manager", "user-manager", "logs-manager", "cognito-user-link", "system-manager", "api-authorizer", "auto-shutoff-manager", "patreon-oidc", "tshock-proxy", "realtime-manager"];
